...
jQuery(function($){
	...
	$('.open-switcher-style').click(function(){
		...
		if($('body').hasClass('opened-switcher')){
			...
			ga('send', 'event', 'switcher', 'click', 'Switcher Closed', 1);
		}else{
			
			$('body').addClass('opened-switcher'); 
			ga('send', 'event', 'switcher', 'click', 'Switcher Opened', 1);
	...
	$('.el .options a').live('click', function(){
		...
		ga('send', 'event', 'switcher', 'click', 'Switcher Option', 1);
	...
	$('.overall_op #export').live('click', function(){
		window.open('index9bd9.html?export_option=1');
	});
